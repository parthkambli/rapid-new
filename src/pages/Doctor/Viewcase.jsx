        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-800">
              {queryCase.createdAt ? new Date(queryCase.createdAt).toLocaleDateString('en-GB', {
                day: '2-digit',
                month: '2-digit',
                year: 'numeric'
              }) : "N/A"}
          ...
          <div>
            ...
            <p className="text-sm text-gray-800">
              {queryCase.updatedAt ? new Date(queryCase.updatedAt).toLocaleDateString('en-GB', {
                day: '2-digit',
                month: '2-digit',
                year: 'numeric'
              }) : "N/A"}
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="text-xs space-y-1">
                      ...
                      {followUp.nextDate && (
                        <div className="flex items-center gap-1">
                          ...
                          <span>{new Date(followUp.nextDate).toLocaleDateString('en-GB', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric'
                          })}</span>
                    ...
                    <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                      ...
                      <span>On: {(followUp.date || followUp.createdAt) ? new Date(followUp.date || followUp.createdAt).toLocaleDateString('en-GB', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric'
                      }) : 'No date'}</span>

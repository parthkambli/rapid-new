...
const AdvocateDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const response = await apiClient.get(apiEndpoints.advocates.dashboard);
  ...
  const handleUpdate = (caseId) => {
    navigate(`/advocate/case/${caseId}/update`);
  };

  const handleHistory = (caseId) => {
    navigate(`/advocate/case/${caseId}/history`);
  };

  const handleClose = (caseId) => {
    navigate(`/advocate/case/${caseId}/close`);
  };

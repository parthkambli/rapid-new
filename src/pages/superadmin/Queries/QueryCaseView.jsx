// // src/pages/Superadmin/QueryCaseView.jsx
...
//       try {
//         const res = await apiClient.get(`/query-cases/${id}`);
//         if (res.data.success) {
...
//   if (loading) {
//     return <div className="text-center py-20">Loading case details...</div>;
//   }

//   if (!caseData) {
//     return <div className="text-center py-20 text-red-600">Case not found</div>;
...
//         <h2 className="text-2xl font-bold text-gray-800">Case Details - {caseData.caseNo || caseData._id}</h2>
//         <button
//           onClick={() => navigate(-1)}
...
//         <h3 className="font-bold text-lg mb-2">Doctor Information</h3>
//         <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
//           <div><strong>Name:</strong> {caseData.doctorName}</div>
//           <div><strong>ID:</strong> {caseData.doctorId}</div>
//           <div><strong>Query Type:</strong> {caseData.queryType}</div>
//           <div><strong>Status:</strong> <span className={`px-2 py-1 rounded text-xs ${caseData.caseStage === 'Closed' ? 'bg-green-200 text-green-800' : 'bg-yellow-200 text-yellow-800'}`}>{caseData.caseStage || 'Open'}</span></div>
//         </div>
//       </div>

//       {/* Query Description */}
//       <div className="mb-6">
//         <h3 className="font-bold text-lg mb-2">Original Query</h3>
//         <div className="bg-gray-100 p-4 rounded border">
//           <p className="text-gray-700">{caseData.queryDescription || caseData.originalQuery || "No description"}</p>
//         </div>
//       </div>
...
//           <p><strong>Age/Gender:</strong> {caseData.ageGender || "N/A"}</p>
//           <p><strong>Contact:</strong> {caseData.contactNo || "N/A"}</p>
//           <p><strong>Address:</strong> {caseData.address || "N/A"}</p>
//         </div>

//         <div className="bg-red-50 p-4 rounded-lg">
//           <h3 className="font-bold mb-2">Opponent Details</h3>
//           <p><strong>Name:</strong> {caseData.opponentName || "N/A"}</p>
//           <p><strong>Relation:</strong> {caseData.relation || "N/A"}</p>
//           <p><strong>Type:</strong> {caseData.opponentType || "N/A"}</p>
//           <p><strong>Contact:</strong> {caseData.opponentContact || caseData.opponentEmail || "N/A"}</p>
//         </div>
//       </div>
...
//           <h3 className="font-bold mb-2">Assigned Expert</h3>
//           <p>{caseData.assignedExpert?.fullName || "Not assigned"}</p>
//         </div>
//         <div className="bg-orange-50 p-4 rounded-lg">
//           <h3 className="font-bold mb-2">Assigned Advocate</h3>
//           <p>{caseData.assignedAdvocate?.fullName || "Not assigned"}</p>
//         </div>
//       </div>

//       {/* Follow-ups */}
//       <div>
//         <h3 className="font-bold text-lg mb-4">Follow-up History ({caseData.followUps?.length || 0})</h3>
//         {caseData.followUps && caseData.followUps.length > 0 ? (
//           <div className="space-y-4">
//             {caseData.followUps.map((fu, idx) => (
//               <div key={fu._id || idx} className="bg-white border rounded-lg p-4 shadow-sm">
//                 <div className="flex justify-between items-start mb-2">
//                   <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">
//                     {fu.stage || "Update"}
//                   </span>
//                   <span className="text-xs text-gray-500">
//                     {new Date(fu.date || fu.createdAt).toLocaleDateString('en-GB')}
//                   </span>
//                 </div>
//                 <p className="text-sm text-gray-700 mb-2">{fu.text || fu.remark || "No remark"}</p>
//                 {fu.nextDate && (
//                   <p className="text-xs text-gray-600">
//                     <strong>Next Follow-up:</strong> {new Date(fu.nextDate).toLocaleDateString('en-GB')}
//                   </p>
//                 )}
//                 {fu.attachment && (
//                   <a
...
//                   By: {fu.user?.fullName || fu.createdBy || "System"}
//                 </p>
//               </div>
//             ))}
//           </div>
//         ) : (
//           <p className="text-gray-500 italic">No follow-ups recorded yet.</p>
//         )}
//       </div>
//     </div>
//   );

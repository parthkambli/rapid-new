...
//         params.search = searchName || searchEmpId;
//       }

//       if (selectedRole) {
//         params.employeeRole = selectedRole;
//       }
...
//           totalPayment: salary.basicSalary || 0,
//           monthDays: salary.attendanceData?.monthDays || 30,
//           perDay: salary.basicSalary ? (salary.basicSalary / (salary.attendanceData?.monthDays || 30)).toFixed(2) : 0,
//           finalPayment: salary.netSalary || 0
//         }));
...
//   useEffect(() => {
//     fetchSalaryData();
//   }, [currentPage, selectedMonth, searchName, searchEmpId, selectedRole]);

//   const handleViewSalaryDetails = (salaryId) => {
//     navigate(`/Superadmin/employee/salary/view/${salaryId}`);
//   };
...
//                 <th className="p-3 font-semibold text-center">BASIC PAYMENT (₹)</th>
...
//                   <tr key={salary._id} className="border-b border-gray-300 hover:bg-gray-100">

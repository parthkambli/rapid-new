...
//         setDoctorCases(casesResponse.data.data || []);
//       } else {
//         setDoctorCases([]);
...
//     if (selectedDoctorId) {
//       fetchCasesForDoctor(selectedDoctorId);
//     }
//   };
...
//     try {
//       const billData = {
//         advocate, doctor, caseNo, caseType, stages, overallGst, otherCharges, discount, remark,
...
//             {loading.advocates ? (
//               <option disabled>Loading advocates...</option>
//             ) : error.advocates ? (
//               <option disabled>Error: {error.advocates}</option>
//             ) : (
//               advocates.map((adv) => (
//                 <option key={adv._id} value={adv._id}>
//                   {adv.fullName} {adv.barCouncilNumber ? `(${adv.barCouncilNumber})` : ''}
//                 </option>
//               ))
//             )}
//           </select>
...
//             ) : error.doctors ? (
//               <option disabled>Error: {error.doctors}</option>
//             ) : (
//               doctors.map((doc) => (
//                 <option key={doc._id} value={doc._id}>
//                   {doc.fullName} {doc.doctorId ? `(${doc.doctorId})` : ''}
//                 </option>
//               ))
//             )}
//           </select>
...
//               className="w-full p-2 border border-gray-300 rounded-md text-sm bg-gray-100"
//             >
//               <option>Error: {error.cases}</option>
//             </select>
...
//                 <option key={caseItem._id} value={caseItem.caseNo}>
//                   {caseItem.caseNo} - {caseItem.id} ({caseItem.queryType})
//                 </option>
//               ))}
//             </select>
//           ) : (

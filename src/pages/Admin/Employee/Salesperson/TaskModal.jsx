...
//     formData.append('title', 'Field Visit Report');
//     formData.append('description', description);

//     images.forEach(img => formData.append('images', img));

//     try {
//       await apiClient.post(apiEndpoints.salesmanTargets.addTask, formData);
...
//               Salesman: <span className="text-blue-600">{employee.fullName}</span> ({employee.employeeId})
//             </p>
//           )}

...
//   const [month, setMonth] = useState((new Date().getMonth() + 1).toString()); // Default: Current Month
//   const [year, setYear] = useState(currentYear.toString());      // Default: Current Year
...
//         const queryParams = {
//           limit: 1000 // Get complete list for the month
//         };
//         if (search) queryParams.search = search;
//         if (month) queryParams.month = month;
//         if (year) queryParams.year = year;

//         const response = await apiHelpers.getList(apiEndpoints.renewalAlerts.indemnityRenewals, queryParams);
...
//     const headers = [
//       "SrNo", "SB No", "Doctor Name", "Policy Start Date",
//       "Insurance Cover", "Policy No", "Policy Type", "Premium", "Expiry Date"
//     ];
...
//         `"${row.doctorName}"`,
//         row.policyStartDate,
//         row.insuranceCover ? row.insuranceCover.replace(/₹|,/g, '') : '',
//         row.policyNo,
//         row.policyType,
...
//     link.href = url;
//     link.setAttribute("download", `Indemnity_Renewals_${month}_${year}.csv`);

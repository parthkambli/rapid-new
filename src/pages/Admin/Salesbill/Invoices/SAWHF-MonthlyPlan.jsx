// src/pages/Admin/Salesbill/Invoices/SAWHF-MonthlyPlan.jsx
...
import TermsConditions from './serviceAgreement(SA)/TermsConditionMonthly';
    ...
    <>
      ...
      <div className="font-[Times New Roman] text-[12px] leading-[18px] print:text-black bg-white">
        ...
        <div className="a4-container">
          ...
          <div className="break-inside-avoid">
            <ParagraphBlock>
              <p className="mb-2 font-bold uppercase ">WHEREAS</p>
              {doctor.doctorType === 'hospital' ? (
                <p>The member having its medical practice at <span className='underline font-bold'>{doctor.formattedHospitalAddress || 'N/A'}</span>.</p>
              ) : (
                <p>The member having his/her medical practice at <span className='underline font-bold'>{doctor.formattedHospitalAddress || 'N/A'}</span>.</p>
              )}
              ...
              <p>The Doctor has approaches to the company and applied for the service package offered by the Company on a monthly basis (via NACH Auto Debit)/Annual and the Company has agreed to provide its services in accordance with the terms and conditions set forth herein.</p>
            </ParagraphBlock>
          </div>

          <WitnessPoints />

          {/* Terms - controlled page break before, fill ~80% with padding-bottom */}
...
export default SAWHFMonthlyPlan;
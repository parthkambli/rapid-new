// Updated pages/service-agreement/YearlySA.jsx
    ...
    <>
      ...
      <div className="font-[Times New Roman] text-[12px] leading-[1.4] print:text-black bg-white">
        ...
        <div className="a4-container">
          ...
          {/* PAGE 2 - POLICY DETAILS, PAYMENT DETAILS, NOTE, WHEREAS */}
          <div className="break-inside-avoid print:break-inside-avoid">
          ...
          <div className="break-inside-avoid print:break-inside-avoid">
            <ParagraphBlock>
              ...
              <p className="print:text-[12px]">The Doctor has approaches to the company and applied for the service package offered by the Company on a yearly basis/Annual and the Company has agreed to provide its services in accordance with the terms and conditions set forth herein.</p>
            </ParagraphBlock>
          </div>

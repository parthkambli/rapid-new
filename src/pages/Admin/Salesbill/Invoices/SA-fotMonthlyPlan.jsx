              ...
              <SectionBox title="SERVICE AGREEMENT">
                ...
                {doctor.hasSpouse && doctor.spouseInfo ? (
                  ...
                  <p className="mb-2 print:mb-2">
                    <b>{doctor.fullName} & {doctor.spouseInfo.fullName}</b> residing at {doctor.address},PIN CODE - {doctor.pincode}, {doctor.city}, {doctor.state}, {doctor.country},  with medical council number <b>{doctor.medicalCouncilNumber} & {doctor.spouseInfo.medicalCouncilNumber}</b> Herein after referred as the doctor the one part.
                  </p>
                ) : doctor.doctorType === 'hospital' ? (

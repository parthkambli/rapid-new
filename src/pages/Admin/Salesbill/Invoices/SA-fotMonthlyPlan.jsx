              ...
              <SectionBox title="SERVICE AGREEMENT">
                ...
                {doctor.hasSpouse && doctor.spouseInfo ? (
                  ...
                  <p className="mb-2 print:mb-2">
                    ...
                    <b>{doctor.hospitalName}</b> having its registered hospital at  {doctor.address}, {doctor.taluka}, {doctor.district}, {doctor.city}, {doctor.state}, {doctor.country}, PIN CODE - {doctor.pincode}, Herein after referred as the doctor the one part.
                  </p>
